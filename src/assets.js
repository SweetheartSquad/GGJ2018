...
import fontImg from './assets/font.fnt.png'; // not using the image directly, but need to make sure it's imported for the xml to reference
import font from './assets/font.fnt.xml';
